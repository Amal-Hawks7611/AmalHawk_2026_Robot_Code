...
public class stage2 extends Command {
    ...
    public stage2(ShooterSubsystem shooterSubsystem) {
    ...
    public void initialize() {
        System.out.println("Fuel STAGE2 Ininialized");
    ...
    public void execute() {
        if (EnabledParts.IS_SHOOTER_ENABLED && timer2.hasElapsed(Shooter.SHOOTER_TIME-Feeder.FEEDER_TIME) & !timer2.hasElapsed(Shooter.SHOOTER_TIME)){
            shooterSubsystem.Shoot(Shooter.STAGE2_SPEED);
    ...
    public void end(boolean interrupted) {
        System.out.println("Fuel STAGE2 Ended");
